...
let form = useForm({
    ...
    notification:'',active:'',department:'',role:'',
    department:props.departments.organization_name,

});

let submitForm=()=>{
    //form.transform(data=>({department:data.department.value,...data})).post('/admin/nodal');
    form.post('/admin/nodal',{
